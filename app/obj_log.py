...
nếu là log in dữ liệu thì:
    obj_log.safe_put_queue({"type":"software","level":"debug","data":"xin chao ban nhe"})
    obj_log.safe_put_queue({"type":"software","level":"warning","data":"xin chao ban nhe"})
    obj_log.safe_put_queue({"type":"software","level":"error","data":"xin chao ban nhe"})
    obj_log.safe_put_queue({"type":"software","level":"critical","data":"xin chao ban nhe"})
    obj_log.safe_put_queue({"type":"software","level":"info","data":"xin chao ban nhe"})
"""
